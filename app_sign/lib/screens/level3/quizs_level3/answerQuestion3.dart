...
import 'package:app_sign/screens/level3/congratulation3.dart';
          ...
          Center(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage("assets/level3/transport_level3/bus.png"),
                  fit: BoxFit.fill,
                ),
                boxShadow: [
                  BoxShadow(
          ...
          Center(
            child: InkWell(
              onTap: () async {
                ...
                if (score >= 390 && score < 410) {
                  await prefs.setInt('score', score! + 20);
                  setState(() {});
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Congratulation3()),
                  );
                } else {
                  Navigator.push(
                    context,
