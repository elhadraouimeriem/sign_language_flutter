...
import 'package:app_sign/screens/level3/ready_level3.dart';
        ...
        children: [
            ...
            Center(
              child: Container(
                ...
                child: Image.asset(
                  'assets/level3/food_level3/strawberry_card.png',
                  fit: BoxFit.fill,
                ),
              ),
            ),
            Container(
              ...
              child: Image.asset(
                'assets/level3/food_level3/strawberry.png',
                fit: BoxFit.fill,
              ),
            ),
            Container(
                  ...
                  child: InkWell(
                    onTap: () async {
                      ...
                      if(score<350)
                      {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Ready_level3()),
                        );
                      }
                    },
                    child:Icon(
