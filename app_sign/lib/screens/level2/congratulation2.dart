...
class Congratulation2 extends StatefulWidget {
  const Congratulation2({Key? key}) : super(key: key);

  @override
  State<Congratulation2> createState() => _Congratulation2State();
}

class _Congratulation2State extends State<Congratulation2> {
  @override
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    ...
                    child: Center(
                      child: Text(
                        'Congratulations! You have passed Level 2 successfully.',
