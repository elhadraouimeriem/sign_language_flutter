...
import 'package:app_sign/screens/level2/congratulation2.dart';
          ...
          Center(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage("assets/level2/animals_level2/giraffe.png"),
                  fit: BoxFit.fill,
                ),
                boxShadow: [
                  BoxShadow(
            ...
            child: InkWell(
              onTap: () async {
                ...
                if (score >= 260 && score < 280) {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Congratulation2()),
                  );
                } else {
                  Navigator.push(
                    context,
