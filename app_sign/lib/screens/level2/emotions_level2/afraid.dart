...
import 'package:app_sign/screens/level2/emotions_level2/angry.dart';
...
class Afraid extends StatefulWidget {
  ...
  @override
  State<Afraid> createState() => _AfraidState();
}

class _AfraidState extends State<Afraid> {
  void alert(int nbr) {
    Alert(
      context: context,
              ...
              children: [
                ...
                Center(
                  child: Container(
                    ...
                    child: Image.asset(
                      'assets/level2/emotions_level2/afraid_card.png',
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
