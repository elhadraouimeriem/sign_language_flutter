...
class Greetings2 extends StatefulWidget {
  const Greetings2({Key? key}) : super(key: key);

  @override
  State<Greetings2> createState() => _Greetings2State();
}

class _Greetings2State extends State<Greetings2> {
  void alert(int nbr) {
    Alert(
      context: context,
              ...
              children: [
                ...
                Center(
                  child: Container(
                    ...
                    child: Image.asset(
                      'assets/level1/greetings_level1/bye_card.png',
                      fit: BoxFit.fill,
                    ),
                  ),
                ),
